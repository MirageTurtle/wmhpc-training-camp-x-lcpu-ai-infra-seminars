...
int main() {
    ...
    // cudaMemcpyDefault causes CUDA to use the value of the source and destination pointers
    // to determine the type of copy to perform
    CUDA_CHECK(cudaMemcpy(d_b, h_b, bytes, cudaMemcpyDefault));
